...
<head>
    <link rel="stylesheet" href="/css/favauction.css"/>
</head>
...
<form method="POST" action="/FavAuctions/filter">
    ...
    <div class="wrapper">
        ...
        <input class="search" name="filter" placeholder="Filtrar tu subasta favorita por titulo" type="text" >
